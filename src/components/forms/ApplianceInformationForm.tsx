...
interface ApplianceInformationFormProps {
  formData: {
...
const ApplianceInformationForm = ({ formData, onInputChange }: ApplianceInformationFormProps) => {
...
export default ApplianceInformationForm;
