...
const DiscussionPage = () => {
  ...
  const getPlaceholderText = () => {
    return "Start a discussion about work orders, repair tips, or reference a WO (e.g., WO-123)...";
  };
  ...
  const mockConversation = {
    ...
    description: 'Team discussion and work order collaboration',
    ...
    <div className={`bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 ${
      ...
      <div className="p-4">
        <h2 className={`font-semibold text-slate-900 dark:text-slate-100 ${
          ...
          {sidebarCollapsed && !isMobile ? 'Team' : 'Team Discussion'}
        </h2>
        {!sidebarCollapsed || isMobile ? (
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
            Collaborate with your team, discuss work orders, and reference specific cases. Type WO-123 to reference a work order.
          </p>
        ) : null}
      </div>
    </div>
  ...
  return (
    ...
    >
      <EnhancedChatMainArea
        ...
        selectedConversation="discussion"
