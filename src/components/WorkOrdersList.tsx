  ...
  if (cases.length === 0) {
    return (
      <div className="text-center py-16">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gun-metal/10 dark:bg-gun-metal/20 mb-4">
        ...
        return (
          ...
          >
                  ...
                  <div>
                    <CardTitle className="text-base font-semibold flex items-center gap-2">
                      {isPublicCase(caseItem) && (
                        <Globe className="h-4 w-4 text-gun-metal dark:text-gun-metal" />
                      )}
            ...
            <CardContent className="space-y-3 pt-0">
              ...
              {isPublicCase(caseItem) && (
                <div className="mt-3 p-3 bg-gun-metal/10 dark:bg-gun-metal/20 rounded-xl border border-gun-metal/30">
                  <p className="text-xs text-gun-metal dark:text-gun-metal flex items-center gap-2">
