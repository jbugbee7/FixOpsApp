    ...
    <div className="flex flex-col h-full bg-background">
      <div className="flex-shrink-0 border-b">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <h1 className="text-3xl font-bold mb-1">Job Scheduling & Dispatching</h1>
          <p className="text-muted-foreground">Manage appointments, dispatch technicians, and optimize routes</p>
        </div>
      </div>
