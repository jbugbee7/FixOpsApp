  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 sm:px-0">
      ...
      <div className="text-center mb-6 sm:mb-8">
        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-red-600 to-black dark:from-red-600 dark:to-white rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4">
          <Wrench className="h-6 w-6 sm:h-8 sm:w-8 text-white" />
        </div>
        <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-red-600 to-black dark:from-red-600 dark:to-white bg-clip-text text-transparent">
          FixOps
        </h1>
